...
5. Download the icon from the material icon [GitHub](/mui/material-ui/tree/master/packages/mui-icons-material/material-icons). You will need to search for the icon due to GitHub limits
