...
(function() {
	...
	const actionTitle = 'Clear Comments';
	const confirmMessage = 'Are you sure you want to clear all comments on %s tracks?';
	const completeMessage = 'Comments are cleared!';
	...
	actions.ClearComments = {
		...
		execute: function() { ClearComments(); }
	}

	window._menuItems.editTags.action.submenu.push({
			action: actions.ClearComments,
			order: 10,
			grouporder: 100
	});
})();
